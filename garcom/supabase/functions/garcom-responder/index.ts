...
const TOPO_DEFAULTS = {
  ...
  maps_url: "",
  horario_texto: "",
  area_entrega: "Curitiba e regiao",
  como_funciona: "Chega quentinho na sua casa em 20 a 30 min. Pediu, preparamos na hora e mandamos pra voce.",
...
function mapTopoConfig(config: Record<string, unknown>) {
  ...
  return {
    ...
    endereco: textOr(topo.endereco, TOPO_DEFAULTS.endereco),
    telefone: textOr(topo.telefone, TOPO_DEFAULTS.telefone),
    maps_url: textOr(topo.maps_url, TOPO_DEFAULTS.maps_url),
    horario_texto: textOr(topo.horario_texto, TOPO_DEFAULTS.horario_texto),
    area_entrega: textOr(topo.area_entrega, TOPO_DEFAULTS.area_entrega),
    como_funciona: textOr(topo.como_funciona, TOPO_DEFAULTS.como_funciona),
